    ...
    $("#filename").change(function(e) {
      ...
      if (e.target.files != undefined) {
          ...
          reader.onload = function(e) {
              ...
              var csvvalues = csvval.map(function (d){
                  return d.split(",");
              });
              console.log(csvvalues[0]);
              for(var i=0;i<csvvalues[0].length;i++)
              {
                  var temp=csvvalues[0][i];
                  csvheader.push(temp);
              }
              ...
              csvvalues.map(function (d){
                rows.push({x:d[0],y:d[1],z:d[2]});
              });
              console.log(rows[0]);
              rows[0] = {x:0, y:0, z:0};
              //rows = csvvalues.split(csvvalues[0]);
              console.log(rows[0]);
